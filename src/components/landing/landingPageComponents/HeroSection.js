                ...
                <div className="col-span-1 px-2 lg:px-0">
                    <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
                        <h1 className="relative w-fit tracking-tighter text-balance font-bold !leading-tight text-gray-900 text-5xl md:text-6xl">
                            Decision receipts for IT/Ops teams that need proof fast
                        </h1>

                        <p className="mt-8 text-balance text-lg max-w-prose text-center font-semibold lg:pr-10 md:text-wrap lg:text-left">
                            Capture a decision in minutes, route approvals, and keep a clean audit trail. Works alongside tickets and email without replacing them.
                        </p>
                        ...
                        <ul className="hidden mt-8 text-left font-medium md:flex flex-col items-center sm:items-start">
                            <div className="space-y-2">
                                <li className="flex gap-1.5 items-center text-left">
                                    ...
                                    Approval trail with names + timestamps
                                </li>
                                <li className="flex gap-1.5 items-center text-left">
                                    <Check className="h-5 w-5 shrink-0 text-green-600" />
                                    Summary + context emails with deep links
                                </li>
                                <li className="flex gap-1.5 items-center text-left">
                                    <Check className="h-5 w-5 shrink-0 text-green-600" />
                                    Searchable decision ledger across tickets/docs
                                </li>
                                <li className="flex gap-1.5 items-center text-left">
                                    <Check className="h-5 w-5 shrink-0 text-green-600" />
                                    Print/PDF-friendly record for audits
                                </li>
                            </div>
                        </ul>

                        {/* CTA button */}
                        <Link href='/app/sign-up' className={cn(buttonVariants({ size: 'lg' }), "flex items-center justify-center mt-8 group")}>
                        ...
                        <div className="mt-12 flex flex-col sm:flex-row sm:items-start items-center gap-5">
                            ...
                            <div className="flex flex-col justify-between items-center sm:items-start">
                                ...
                                <p><span className="font-semibold">Built for</span> IT/Ops teams</p>
                            </div>
                        </div>
                    </div>
                </div>
