            ...
            <div className='flex flex-col md:flex-row max-w-5xl mx-auto px-14 py-10 gap-10 bg-gradient-to-br from-sky-200 via-sky-300 to-sky-400 rounded-3xl'>
                <div className="space-y-6">
                    <h2 className='relative tracking-tight font-bold text-3xl md:text-4xl'>
                        ...
                        Never ask “who approved this?” again
                    </h2>

                    <p className='text-lg font-medium leading-relaxed text-gray-700'>
                        Decidex gives IT/Ops teams a decision receipt with clear ownership, approvals, and searchable context. Capture decisions fast, prove authority, and move on.
                    </p>

                    <div className="w-full lg:w-1/4">
                        <Link href='/app/sign-up' className={cn(buttonVariants({ size: "lg" }), "flex items-center justify-center group px-4")}>
