            ...
            <MaxWidthWrapper className='pb-10 pt-20'>
                <div className='max-w-3xl mx-auto tracking-tight flex flex-col items-center justify-center gap-5'>
                    <div className="flex items-center justify-center gap-1.5">
                        ...
                        <h2 className='font-bold text-xl md:text-3xl text-center'>
                            Decisions scattered across tickets, email, and chat
                        </h2>
                    </div>
                    ...
                    <div className="flex items-center justify-center gap-1.5">
                        ...
                        <h2 className='font-bold text-xl md:text-3xl text-center text-balance'>
                            One decision receipt you can find months later
                        </h2>
                    </div>
                </div>

                <div className="flex flex-col gap-10 lg:flex-row lg:max-w-4xl lg:mx-auto items-center justify-center lg:gap-8 my-16">
                    <div className='flex w-full sm:flex-1 flex-col items-center bg-primary-foreground rounded-2xl shadow-md px-6 py-12'>
                        <ul className="text-left font-medium flex flex-col items-center sm:items-start">
                            <div className="space-y-2 tracking-wide text-xl ">
                                ...
                                <li className="flex gap-1.5 items-center text-left">
                                    ...
                                    Approval evidence buried in threads
                                </li>
                                <li className="flex gap-1.5 items-center text-left">
                                    <X className="h-4 w-4 shrink-0 text-red-500" />
                                    No single owner to chase decisions
                                </li>
                                <li className="flex gap-1.5 items-center text-left">
                                    <X className="h-4 w-4 shrink-0 text-red-500" />
                                    Hard to retrieve during audits and handoffs
                                </li>
                                <li className="flex gap-1.5 items-center text-left">
                                    <X className="h-4 w-4 shrink-0 text-red-500" />
                                    Ticket closures erase the context
                                </li>
                            </div>
                        </ul>
                    </div>

                    <div className='flex w-full sm:flex-1 flex-col items-center bg-primary/10 rounded-2xl shadow-md px-6 py-12'>
                        <ul className="text-left font-medium flex flex-col items-center sm:items-start">
                            <div className="space-y-2 tracking-wide text-xl">
                                ...
                                <li className="flex gap-1.5 items-center text-left">
                                    ...
                                    Clear owner and required approvers
                                </li>
                                <li className="flex gap-1.5 items-center text-left">
                                    <Check className="h-4 w-4 shrink-0 text-green-600" />
                                    Summary + context saved with the decision
                                </li>
                                <li className="flex gap-1.5 items-center text-left">
                                    <Check className="h-4 w-4 shrink-0 text-green-600" />
                                    Searchable ledger with deep links
                                </li>
                                <li className="flex gap-1.5 items-center text-left">
                                    <Check className="h-4 w-4 shrink-0 text-green-600" />
                                    Print/PDF-ready for compliance
                                </li>
                            </div>
                        </ul>
                    </div>
                ...
                <div className="max-w-lg mx-auto my-20 flex flex-col items-center sm:items-start">
                    ...
                    <div className='text-center font-semibold text-balance text-gray-800'>
                        “We finally know who approved what, and can find it months later. It’s the decision log our tickets were missing.”
                    </div>
                    ...
                    <div className='flex mx-auto items-center justify-center gap-4 my-6'>
                        ...
                        <div className="flex flex-col">
                            ...
                            <p className='text-sm'>IT Operations Manager</p>
                        </div>
                    </div>
                </div>
            </MaxWidthWrapper>
