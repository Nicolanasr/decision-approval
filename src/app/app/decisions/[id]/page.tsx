        ...
        <div className="min-h-screen bg-neutral-50 px-6 py-12">
            <main className="mx-auto flex w-full max-w-[720px] flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                        {canEdit ? (
                            <Button variant="outline" asChild>
                                <Link href={`/app/decisions/${decision.id}/edit`}>Edit</Link>
                            </Button>
                        ) : null}
                        <Button variant="outline" asChild>
                            <Link
                                href={`/app/decisions/${decision.id}/print`}
                                target="_blank"
                                rel="noreferrer"
                            >
                                Print
                        ...
                        <Button variant="outline" asChild>
                            <Link href="/app">Back to log</Link>
                        </Button>
                    </div>
                </header>
                ...
                <div className="space-y-6">
                    <div className="grid gap-x-2 gap-y-4 grid-cols-1 lg:grid-cols-[minmax(0,1fr)_260px]">
                                ...
                                {links && links.length > 0 ? (
                                    links.map((link) => (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noreferrer"
                                            className="flex flex-col rounded-md border border-neutral-100 px-3 py-2 text-sm text-neutral-700 hover:border-neutral-200"
                                        >
